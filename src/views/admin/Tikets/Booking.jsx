...
export default function TiketBooking() {
  ...
  const fetchData = async (pageNumber = 1, keywords = "") => {
    ...
    await Api.get(`/api/admin/tiket-booking?search=${keywords}&page=${page}`, {
      //header
      headers: {
        //header Bearer + Token
              ...
              <div className="row">
                <div className="col-md-3">
                  <Link
                    ...
                    type="button"
                  >
                    <i className="fa fa-long-arrow-alt-left me-2"></i> Pesan Tiket
                  </Link>
                </div>
                    ...
                    <table className="table table-bordered table-centered mb-0 rounded">
                      <thead className="thead-dark">
                        <tr className="border-0 text-center">
                          ...
                          <th className="border-0">No.Booking</th>
                            ...
                            layanans.map((layanan, index) => (
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  layanan.is_active == 2 ? (
                                    <Link
                                      to={`/admin/tiket-edit/${layanan.id}`}
                                    ...
                                    layanan.is_active == 1 ? (
                                        <Link
                                        to={`/admin/tiket-cetak/${layanan.id}`}
                                        className="btn btn-md btn-primary border-0 shadow-sm mb-3"
                                        type="button"
                                      >
