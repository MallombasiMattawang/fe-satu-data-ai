...
export default function ImportDbRbm() {
  //name page
  document.name = "Import DB RBM";
  ...
  const [year, setYear] = useState("2023"); // Default tahun
  ...
  const storeDb = async (e) => {
    ...
    //sending data
    await Api.post("/api/admin/import-db-rbm", formData, {
      //header
      headers: {
            ...
            <div className="col-md-12">
              ...
              <div className="card border-0 rounded shadow-sm border-top-success">
                <div className="card-body">
                  <h6>
                    <i className="fa fa-pencil-alt"></i> Create Database RBM
                  </h6>
                  <hr />
