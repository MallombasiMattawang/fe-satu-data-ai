...
export default function UsersEdit() {
  //title page
  document.title = "Edit User - Tiket Digital";
  ...
  const [pintuMasukID, setPintuMasukID] = useState("");
  ...
  const [pintuMasuks, setPintuMasuks] = useState([]);
  ...
  //function "fetchDataRoles"
  const fetchDataPintu = async () => {
    await Api.get("/api/admin/pintu-masuk-all", {
      //header
      headers: {
        //header Bearer + Token
        Authorization: `Bearer ${token}`,
      ...
      //set response data to state "roles"
      setPintuMasuks(response.data.data);
    });
  };
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={updateUser}>
                    ...
                    <div className="row">
                      ...
                      <div className="mb-3">
                        <label className="form-label fw-bold">Pintu Masuk</label>
                        <select
                          className="form-select"
                          value={pintuMasukID}
                          onChange={(e) => setPintuMasukID(e.target.value)}
                        >
                          <option value="">-- Select Pintu Masuk --</option>
                          {pintuMasuks.map((pintuMasuk) => (
                            <option value={pintuMasuk.id} key={pintuMasuk.id}>
                              {pintuMasuk.name}
                            </option>
                          ))}
                        </select>
