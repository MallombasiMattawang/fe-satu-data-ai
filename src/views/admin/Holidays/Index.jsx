...
export default function HolidaysIndex() {
    ...
    const fetchData = async (pageNumber = 1, keywords = "") => {
        ...
        await Api.get(`/api/admin/holidays?search=${keywords}&page=${page}`, {
            //header
            headers: {
                //header Bearer + Token
            ...
            //set data response to state "setHolidays"
                                        ...
                                        <table className="table table-bordered table-centered mb-0 rounded">
                                            <thead className="thead-dark">
                                                <tr className="border-0">
                                                    ...
                                                    <th className="border-0">Tanggal Libur</th>
                                                    ...
                                                    holidays.length > 0 ? (
                                                        ...
                                                        holidays.map((holiday, index) => (
                                                            <tr key={index}>
                                                                ...
                                                                <td>{dateFormat(holiday.tgl_libur)}</td>
                                                                <td>{holiday.ket}</td>
                                                                <td className="text-center">                                                                  

                                                                    {hasAnyPermission(["layanans.index"]) && (
                                                                        <button
                                                                            onClick={() => deletePost(holiday.id)}
